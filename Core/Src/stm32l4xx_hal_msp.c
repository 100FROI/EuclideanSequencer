...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA7     ------> ADC1_IN12
    */
    HAL_GPIO_DeInit(GPIOA, CV2_CVSEQ1_Pin|CV1_CVSEQ1_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB0     ------> ADC2_IN15
    */
    HAL_GPIO_DeInit(CV1_CVSEQ2_GPIO_Port, CV1_CVSEQ2_Pin);

    HAL_GPIO_DeInit(CV2_CVSEQ2_GPIO_Port, CV2_CVSEQ2_Pin);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspDeInit 0 */
    ...
    PA5     ------> DAC1_OUT2
    */
    HAL_GPIO_DeInit(GPIOA, CVSEQ2_OUT_Pin|CVSEQ1_OUT_Pin);
